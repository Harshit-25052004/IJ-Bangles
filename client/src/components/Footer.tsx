...
export default function Footer() {
  return (
    <footer id="contact" className="bg-primary text-primary-foreground relative border-t-8 border-secondary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 font-light text-primary-foreground/80">
              <li><Link href="/" className="hover:text-secondary transition-colors inline-block" data-testid="link-home">Home</Link></li>
              <li><Link href="/collections" className="hover:text-secondary transition-colors inline-block" data-testid="link-collections">Collections</Link></li>
              <li><a href="/#heritage" className="hover:text-secondary transition-colors inline-block" data-testid="link-heritage">Heritage</a></li>
              <li><a href="#contact" className="hover:text-secondary transition-colors inline-block" data-testid="link-contact">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-light text-primary-foreground/80 mb-8">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+917010080079" className="hover:text-secondary transition-colors">+91 70100 80079</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail size={16} className="text-secondary shrink-0" />
                <a href="mailto:hello@ijbangles.com" className="hover:text-secondary transition-colors">hello@ijbangles.com</a>
              </li>
              <li className="flex items-start gap-2">
                <MapPin size={16} className="text-secondary shrink-0 mt-1" />
                <span>Hawa Mahal Road, Jaipur,<br />Rajasthan, India</span>
              </li>
            </ul>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full border border-secondary/50 flex items-center justify-center text-secondary hover:bg-secondary hover:text-primary transition-all" 
